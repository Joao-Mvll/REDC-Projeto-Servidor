...
<head>
    ...
    <link rel="stylesheet" href="${cp}/css/classificacoes/classificacoes.css">
    <script src="${cp}/js/classificacoes/classificacoes.js"></script>
    ...
    <div class="sidebar">
        ...
        <nav>
            <ul>
                ...
                <li><a href="generos.jsp">Gêneros</a></li>
            </ul>
        </nav>
    </div>
